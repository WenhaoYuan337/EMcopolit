...
parser.add_argument('--nepochs', type=int, default=70, help='saved model of which epochs')
...
model_path = "checkpoint/{}/netG_model_epoch_80.pth".format(opt.dataset, opt.nepochs)
